...
export const List: FunctionComponent<Props> = ({ calendars }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">Calendar List</h1>
      <Link
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {calendars &&
          ...
          calendars.map(
            (calendar) =>
              calendar["@id"] && (
                <tr className="py-2" key={calendar["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(calendar["@id"], "/calendars/[id]"),
                        name: calendar["@id"],
                      }}
                    />
                  </th>
